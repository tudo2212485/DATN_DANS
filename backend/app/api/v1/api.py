...
api_router.include_router(forecast.router, prefix="/forecast", tags=["Forecast & ML (Legacy)"])
api_router.include_router(predictions.router, prefix="/predictions", tags=["Predictions & ML Pipeline"])
